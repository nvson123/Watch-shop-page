...
import { clx, IconButton, Kbd } from '@medusajs/ui';
...
>(({ className, ...props }, ref) => {
  return (
    <FocusModalPrimitives.Overlay
      ref={ref}
      className={clx(
        'fixed inset-0 z-10 bg-ui-bg-overlay',
  ...
  return (
    <FocusModalPortal {...portalProps}>
      ...
      <FocusModalPrimitives.Content
        ref={ref}
        className={clx(
          'fixed inset-2 z-10 flex flex-col overflow-hidden rounded-lg border bg-ui-bg-base shadow-elevation-modal outline-none',
    ...
    >
      <div className="flex items-center gap-x-2">
        <FocusModalPrimitives.Close asChild>
          <IconButton size="base" type="button" variant="transparent">
            <XMark />
          </IconButton>
